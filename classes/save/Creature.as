...
{
	import classes.save.CockClass;
	import classes.save.VaginaClass;
	import classes.save.BreastRowClass;
	import classes.save.AssClass;
	import classes.save.StatusAffectClass;
	public class Creature
	{
		...
		*/	
		...
		public var eyeColor:String = "blue";
		...
		public function foot():String 
{
		...
		public function knockUp(type:int = 0,incubation:int = 0,beat:int = 100,arg:int = 0):void {
			...
			if(hasStatusAffect("Contraceptives") >= 0) return;
			var bonus:int = 0;
